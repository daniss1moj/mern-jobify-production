...
import { AuthFetchConfig, ContextInterface } from "../types";
...
const AppProvider = ({ children }: Props) => {
	...
	const handleChange = ({ name, value }: Record<string, string>) => {
		dispatch({ type: HANDLE_CHANGE, payload: { name, value } });
	};

	const addUserToLocalStorage = ({ user, token, location }: Record<string, string>) => {
